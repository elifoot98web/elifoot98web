export class ColorHelper {
    static getCSSFilterFromColor(hexColorString: string): string {
        const color = ColorHelper.getColorFromHexString(hexColorString);
...
// Credit for the implementation below goes to MultiplyByZer0 for their post https://stackoverflow.com/a/43960991
class Color {
    r: number;
    g: number;
    b: number;
